...
def test_adam_fp16_non0_loss_scale(tmpdir):
    config_dict = {
        "train_batch_size": 4,
        "steps_per_print": 1,
        "optimizer": {
    ...
    @distributed_test(world_size=[1])
    def _test_adam_fp16_non0_loss_scale(args, model, hidden_dim):
        model, _, _,_ = deepspeed.initialize(args=args,
                                             model=model,
                                             model_parameters=model.parameters(),
                                             dist_init_required=False)
    ...
    _test_adam_fp16_non0_loss_scale(args=args, model=model, hidden_dim=hidden_dim)


def test_adam_fp16_zero_non0_loss_scale(tmpdir):
    config_dict = {
        "train_batch_size": 4,
        "steps_per_print": 1,
        "optimizer": {
    ...
    @distributed_test(world_size=[1])
    def _test_adam_fp16_zero_non0_loss_scale(args, model, hidden_dim):
        model, _, _,_ = deepspeed.initialize(args=args,
                                             model=model,
                                             model_parameters=model.parameters(),
                                             dist_init_required=False)
    ...
    _test_adam_fp16_zero_non0_loss_scale(args=args, model=model, hidden_dim=hidden_dim)
